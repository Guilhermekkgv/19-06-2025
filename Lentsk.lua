...
CancelButton.MouseButton1Click:Connect(function()
    if not cancelButtonClicked then
        ...
        TweenService:Create(CancelButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(200, 80, 150)}):Play()
        task.wait(0.3)
        TweenService:Create(CancelButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(255, 105, 180)}):Play()
...
ConfirmButton.MouseButton1Click:Connect(function()
    if not confirmButtonClicked then
        ...
        TweenService:Create(ConfirmButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(200, 80, 150)}):Play()
        task.wait(0.3)
        TweenService:Create(ConfirmButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(255, 105, 180)}):Play()
...
function LinuxLib.Tab(config)
    ...
    local function SelectTab()
        ...
        if TabIcon then
            TabIcon.ImageColor3 = Color3.fromRGB(255, 105, 180)
        end
    ...
    if tabOrder == 1 and not DefaultTab then
        DefaultTab = tabIndex
    end
    ...
    function TabElements.Button(config)
        ...
        Btn.MouseButton1Click:Connect(function()
            if not buttonClicked then
                ...
                task.wait(0.3)
                TweenService:Create(BtnFrame, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(21, 21, 21)}):Play()
                buttonClicked = false
            end
        ...
        local function UpdateToggle(thisToggle)
            ...
            if thisTrack and thisKnob then
                ...
                if currentState then
                    TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(255, 105, 180)}):Play()
...
if DefaultTab then
    ...
    local tab = Tabs[DefaultTab]
    if tab then
        tab.Content.Visible = true
        tab.TitleFrame.Visible = true
        ...
        tab.Button.BorderColor3 = Color3.fromRGB(39, 39, 42)
        
        if tab.Icon then
            tab.Icon.ImageColor3 = Color3.fromRGB(255, 105, 180)
        end
    end
end
